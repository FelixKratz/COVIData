...
fitParamsToModel(germanData['confirmed'][4:20], 
                 initialGuess={'beta': 0.6,  # The parameter controlling how often a susceptible-infected contact results in a new exposure.
