...
fitParamsToModel(germanData['confirmed'][4:40],
                 initialGuess={'beta': 0.3243884736499208,  # The parameter controlling how often a susceptible-infected contact results in a new exposure.
                               'gamma':0.46346672560988056,  # The rate an infected recovers and moves into the resistant phase.
                               'sigma': 19.840050931353158, # The rate at which an exposed person becomes infective.
