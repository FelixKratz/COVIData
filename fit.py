...
fitParamsToModel(germanData['confirmed'][4:],
                 initialGuess={'beta': 0.2814924295824709,  # The parameter controlling how often a susceptible-infected contact results in a new exposure.
                               'gamma': 0.3435135260650802,  # The rate an infected recovers and moves into the resistant phase.
                               'sigma': 19.963873286091008, # The rate at which an exposed person becomes infective.
